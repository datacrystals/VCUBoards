...
(library Library_1
	...
	(symbolDef "LTST-C230CKT" (originalName "LTST-C230CKT")
	...
	(compDef "LTST-C230CKT" (originalName "LTST-C230CKT") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C230CKT"))
		...
		(attr "Mouser Part Number" "859-LTST-C230CKT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Lite-On/LTST-C230CKT?qs=Ajas4iFhtucdJAOTHdHdqw%3D%3D")
		(attr "Manufacturer_Name" "Lite-On")
		(attr "Manufacturer_Part_Number" "LTST-C230CKT")
		(attr "Description" "Standard LEDs - SMD Red Clear 638nm")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "LTST-C230CKT.stp")
