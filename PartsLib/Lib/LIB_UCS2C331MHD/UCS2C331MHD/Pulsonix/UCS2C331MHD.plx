...
(library Library_1
	...
	(patternDef "CAPPRD750W80D1825H3200" (originalName "CAPPRD750W80D1825H3200")
		...
		(layerContents (layerNumRef 28)
			(arc (pt 3.75, 0) (radius 9.125) (startAngle 0.0) (sweepAngle 0.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 3.75, 0) (radius 9.125) (startAngle 180.0) (sweepAngle 180.0) (width 0.025))
		)
	)
	...
	(compDef "UCS2C331MHD" (originalName "UCS2C331MHD") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "http://nichicon-us.com/english/products/pdfs/e-ucs.pdf")
		(attr "<Component Height>" "32")
		(attr "<STEP Filename>" "UCS2C331MHD.stp")
