...
//1408252/1553794/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TLV6001QDCKRQ1" (originalName "TLV6001QDCKRQ1")
	...
	(compDef "TLV6001QDCKRQ1" (originalName "TLV6001QDCKRQ1") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "OUT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "5" (pinName "V+") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Power))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV6001QDCKRQ1"))
		...
		(attr "Mouser Part Number" "595-TLV6001QDCKRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV6001QDCKRQ1?qs=qSfuJ%252Bfl%2Fd4YmnuAK2Ksyg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TLV6001QDCKRQ1")
		(attr "Description" "Low-Power, RRIO, 1-MHz, Operational Amplifier for Cost-Sensitive Systems")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tlv6001-q1")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TLV6001QDCKRQ1.stp")
