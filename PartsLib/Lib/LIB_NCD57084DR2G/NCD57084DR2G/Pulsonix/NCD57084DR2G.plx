...
//15904401/1553794/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "NCD57084DR2G" (originalName "NCD57084DR2G")
	...
	(compDef "NCD57084DR2G" (originalName "NCD57084DR2G") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "DESAT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VS") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NCD57084DR2G"))
		...
		(attr "Mouser Part Number" "863-NCD57084DR2G")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/NCD57084DR2G?qs=iLbezkQI%252BshVJf1cw%252BEJ9A%3D%3D")
		(attr "Manufacturer_Name" "onsemi")
		(attr "Manufacturer_Part_Number" "NCD57084DR2G")
		(attr "Description" "High Peak Output Current (+7 A/-7 A); Short Propagation Delays with Accurate Matching; High Transient & Electromagnetic Immunity; 2.5 KVrms On-Chip Galvanic Isolation; Wide Bias Voltage Ranges and Input Voltage Range")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/NCD57084-D.PDF")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "NCD57084DR2G.stp")
