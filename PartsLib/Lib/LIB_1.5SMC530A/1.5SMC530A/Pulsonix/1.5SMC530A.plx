...
(library Library_1
	...
	(symbolDef "1.5SMC530A" (originalName "1.5SMC530A")
	...
	(compDef "1.5SMC530A" (originalName "1.5SMC530A") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "1.5SMC530A"))
		...
		(attr "<Hyperlink>" "https://www.littelfuse.com/media?resourcetype=datasheets&itemid=fca4a2fb-129a-4d31-849b-1393b105dcb5&filename=littelfuse-tvs-diode-1-5smc-datasheet")
		(attr "<Component Height>" "2.62")
		(attr "<STEP Filename>" "1.5SMC530A.stp")
