...
(library Library_1
	...
	(compDef "UCC27424QDRQ1" (originalName "UCC27424QDRQ1") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "ENBA") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "8" (pinName "ENBB") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/ucc27424-q1")
		(attr "Height" "1.75 mm")
	)
