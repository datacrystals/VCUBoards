...
//752232/1553794/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "UCC27424QDRQ1" (originalName "UCC27424QDRQ1")
	...
	(compDef "UCC27424QDRQ1" (originalName "UCC27424QDRQ1") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "ENBA") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "ENBB") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "UCC27424QDRQ1"))
		...
		(attr "Mouser Part Number" "595-UCC27424QDRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/UCC27424QDRQ1?qs=3WadRV20yGwTLMr0pUhVuw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "UCC27424QDRQ1")
		(attr "Description" "Automotive Dual 4A High Speed Low-Side MOSFET Driver With Enable")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/ucc27424-q1")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "UCC27424QDRQ1.stp")
