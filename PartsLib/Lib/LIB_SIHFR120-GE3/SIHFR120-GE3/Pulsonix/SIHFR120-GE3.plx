...
(library Library_1
	...
	(patternDef "SIHFR120GE3" (originalName "SIHFR120GE3")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.828) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.175 5.05) (pt 3.175 5.05) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.175 5.05) (pt 3.175 -1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.175 -1) (pt -3.175 -1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.175 -1) (pt -3.175 5.05) (width 0.025))
		)
	...
	(compDef "SIHFR120-GE3" (originalName "SIHFR120-GE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://www.mouser.in/datasheet/2/427/91266-1768752.pdf")
		(attr "<Component Height>" "2.38")
		(attr "<STEP Filename>" "SIHFR120-GE3.stp")
		(attr "<STEP Offsets>" "X=0;Y=1.71;Z=1.45")
