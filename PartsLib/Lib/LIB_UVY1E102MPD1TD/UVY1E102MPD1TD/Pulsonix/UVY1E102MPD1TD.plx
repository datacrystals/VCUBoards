...
//888549/1553794/2.50/2/3/Capacitor Polarised
...
(library Library_1
	...
	(patternDef "CAPPRD500W60D1025H1750" (originalName "CAPPRD500W60D1025H1750")
		(multiLayer
	...
	(symbolDef "UVY1E102MPD1TD" (originalName "UVY1E102MPD1TD")
	...
	(compDef "UVY1E102MPD1TD" (originalName "UVY1E102MPD1TD") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "UVY1E102MPD1TD"))
		(attachedPattern (patternNum 1) (patternName "CAPPRD500W60D1025H1750")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "647-UVY1E102MPD1TD")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nichicon/UVY1E102MPD1TD?qs=gtReTMvImqniEnVqgrfK9Q%3D%3D")
		(attr "Manufacturer_Name" "Nichicon")
		(attr "Manufacturer_Part_Number" "UVY1E102MPD1TD")
		(attr "Description" "Cap Aluminum Lytic 1000uF 25V 20% (10 X 16mm) Radial 5mm 610mA 1000h 105C Ammo")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/5/UVY1E102MPD1TD.pdf")
		(attr "<Component Height>" "17.5")
		(attr "<STEP Filename>" "UVY1E102MPD1TD.stp")
