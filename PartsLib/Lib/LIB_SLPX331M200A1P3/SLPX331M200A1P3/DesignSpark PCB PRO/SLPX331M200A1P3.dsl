SamacSys ECAD Model
661135/1553794/2.50/2/3/Capacitor Polarised
...
(library Library_1
	...
	(patternDef "CAPPRD1000W190D2250H2700" (originalName "CAPPRD1000W190D2250H2700")
		(multiLayer
		...
		(layerContents (layerNumRef 28)
			(arc (pt 5, 0) (radius 11.25) (startAngle 0.0) (sweepAngle 0.0) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 5, 0) (radius 11.25) (startAngle 180.0) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "SLPX331M200A1P3" (originalName "SLPX331M200A1P3")
	...
	(compDef "SLPX331M200A1P3" (originalName "SLPX331M200A1P3") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SLPX331M200A1P3"))
		(attachedPattern (patternNum 1) (patternName "CAPPRD1000W190D2250H2700")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "598-SLPX331M200A1P3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Cornell-Dubilier-CDE/SLPX331M200A1P3?qs=tRzVlScAa5ofnbB%2FIUpkZA%3D%3D")
		(attr "Manufacturer_Name" "Cornell Dubilier")
		(attr "Manufacturer_Part_Number" "SLPX331M200A1P3")
		(attr "Description" "Cap Aluminum Lytic 330uF 200V 20% (22 X 25mm) Snap-In 10mm 0.603 Ohm 1510mA 3000h 85C")
		(attr "Datasheet Link" "https://www.arrow.com/en/products/slpx331m200a1p3/cornell-dubilier-electronics")
		(attr "Height" "27 mm")
	)
