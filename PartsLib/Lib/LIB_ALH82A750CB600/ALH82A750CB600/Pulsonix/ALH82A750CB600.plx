...
(library Library_1
	...
	(patternDef "ALH82A750CB600" (originalName "ALH82A750CB600")
		...
		(layerContents (layerNumRef 28)
			(line (pt -10 0) (pt -10 0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 5, 0) (radius 15) (startAngle 180) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 20 0) (pt 20 0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 5, 0) (radius 15) (startAngle .0) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "ALH82A750CB600" (originalName "ALH82A750CB600") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "https://search.kemet.com/component-documentation/download/specsheet/ALH82A750CB600")
		(attr "<Component Height>" "32")
		(attr "<STEP Filename>" "ALH82A750CB600.stp")
