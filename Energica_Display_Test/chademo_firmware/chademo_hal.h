...
/**
 * @brief Initialize MCP2515 with a specific bitrate.
 * @param ch   CAN channel to initialize
 * @param kbps Bitrate in kbps (supported: 125, 250, 500, 1000)
 * @return true on success, false if MCP2515 not responding or bitrate unsupported
 */
